...
def check_mode_registry() -> None:
    ...
    text = read(rel_path)
    expect_contains(rel_path, "Last updated: v3.8.2 (2026-05-17)")
    for heading in (
...
def check_claude_md() -> None:
    ...
    expect_contains(rel_path, "**Suite version**: 3.8.2")
    for forbidden in (
...
def check_readme_sections() -> None:
    ...
    expect_contains(rel_path, "version-v3.8.2-blue")
    expect_contains(rel_path, "releases/tag/v3.8.2")
